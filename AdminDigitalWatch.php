...
<div class="main">
    <div class="container product">
        ...
        <div class="row">
        <?php
	    $product_array = $db_handle->runQuery("SELECT * FROM product WHERE code LIKE 'Di%' ORDER BY id ASC");
...
// Define the query:
$q = "SELECT id, name, code, price FROM product WHERE code LIKE 'Di%' ORDER BY id ASC";
...
while ($row = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
    ...
    echo '<tr bgcolor="' . $bg . '">
		<td align="left"><a href="EditProd.php?id=' .$row['id'] .'">Edit</a></td>
		<td align="left"><a href="DeleteProd.php?id=' .$row['id'] .'">Delete</a></td>
